class BmcMasterResponse {
  int? responseStatus;
  String? responseMessage;
  ResponseData? responseData;

  BmcMasterResponse({this.responseStatus, this.responseMessage, this.responseData});

  factory BmcMasterResponse.fromJson(Map<String, dynamic> json) {
    return BmcMasterResponse(
