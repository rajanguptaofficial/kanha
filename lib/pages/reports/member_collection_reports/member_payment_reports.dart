...
class MemberPaymentReportScreen extends StatelessWidget {
  MemberPaymentReportScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Member Payment Report',style: TextStyle(color: Colors.white,fontWeight: FontWeight.w600),),
