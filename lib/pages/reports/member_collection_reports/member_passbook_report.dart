...
class MemberPassbookReportScreen extends StatelessWidget {
  MemberPassbookReportScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Member Passbook',style: TextStyle(color: Colors.white,fontWeight: FontWeight.w600),),
