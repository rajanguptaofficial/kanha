...
class RMRDLabCheckListReportScreen extends StatelessWidget {
  RMRDLabCheckListReportScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Lab Checklist',style: TextStyle(color: Colors.white,fontWeight: FontWeight.w600),),
