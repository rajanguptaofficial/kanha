...
class RMRDDockCheckListReportScreen extends StatelessWidget {
  RMRDDockCheckListReportScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Dock Checklist',style: TextStyle(color: Colors.white,fontWeight: FontWeight.w600),),
