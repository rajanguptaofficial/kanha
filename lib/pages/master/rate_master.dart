                        ...
                        child: DataTable(
                          ...
                          rows: controller.rateData.map((data) {
                            return DataRow(cells: [
                              ...
                              DataCell(Text(data['rateLocation'] ?? '')),
                              DataCell(Text(data['effectiveDate'] ?? '')),
                              DataCell(Text(data['effectiveShift'] ?? '')),
                              DataCell(Text(data['uploadDate'] ?? '')),
                              DataCell(Text(data['downloadDate'] ?? '')),
                            ]);
                          }).toList(),
                        ),
                      ),
