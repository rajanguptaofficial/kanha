...
import 'package:kanha_bmc/controller/procurement/procurement_controller.dart';
...
class ProcurementScreen extends StatelessWidget {
  ProcurementScreen({super.key});

  // Instance of GetX controller
  final ProcurementController controller = Get.put(ProcurementController());
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: 
       ProcCustomAppBar(title:'Procurement'),
